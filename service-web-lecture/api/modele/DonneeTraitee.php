...
class DonneeTraitee extends HistoriqueDonneMesuree
{
    ...
    private $idDonneTraitee;
    private $historiqueDonneeBouee;
    private $valide;

    /**
     * DonneeTraitee constructor.
     * @param $idDonneTraitee
     * @param $historiqueDonneeBouee
     * @param $valide
     */
    public function __construct($idDonneTraitee, $historiqueDonneeBouee, $valide)
    {
        $this->idDonneTraitee = $idDonneTraitee;
     ...
     * @return mixed
     */
    public function getIdDonneTraitee()
    {
        return $this->idDonneTraitee;
    }

    /**
     * @param mixed $idDonneTraitee
     */
    public function setIdDonneTraitee($idDonneTraitee)
    {
        $this->idDonneTraitee = $idDonneTraitee;
    }
