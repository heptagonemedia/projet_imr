            ...
            <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        ...
                        foreach ($calculs as $calcul){
                        if(!$calcul->getEnregistre()) { ?>
                        <li><a class="waves-effect waves-teal" href="{{action('ResultatController@navigerVersResultatNonEnregistre', $calcul->getId())}}"><i aria-hidden="true" class="material-icons">new_releases</i> <span style="font-size: 10px" ><?php echo $calcul->getEtiquette(); ?></span></a></li>
                        <?php }
                        }
                        }?>
                    </ul>
