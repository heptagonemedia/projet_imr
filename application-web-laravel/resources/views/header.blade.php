        ...
        <div class="row">
            ...
            @if (strpos($_SERVER['REQUEST_URI'], "accueil") !== false)
                ...
                <div class="col black m1 l4 center-align">
                    <button data-target="slide-out" class="sidenav-trigger btn black white-text"><i aria-hidden="true" aria-label="Ouvrir le menu" class="material-icons" id="menu">menu</i></button>
                </div>
                ...
                @else @if (strpos($_SERVER['REQUEST_URI'], "nouveauCalcul") !== false)
                      ...
                      @else @if (strpos($_SERVER['REQUEST_URI'], "test") !== false)
                                ...
                                <div class="col s1 m1 l4 center-align"><button data-target="slide-out" class="sidenav-trigger btn black white-text"><i aria-label="Ouvrir le menu"  aria-hidden="true" class="material-icons" id="menu">menu</i></button></div>
