...
-- \COPY mesure (id_historique_donnee_bouee, date_saisie, id_type_donnee_mesuree, valeur) FROM './mockdata/mesure.csv' DELIMITER ',' CSV;
-- \COPY donnee_traitee (id_historique_donnee_bouee, date_saisie, valide) FROM './mockdata/donnee_traitee.csv' DELIMITER ',' CSV;
-- \COPY type_calcul (etiquette) FROM './mockdata/type_calcul.csv' DELIMITER ',' CSV;
-- \COPY calcul_enregistre (id_bouee, date_debut, date_fin, frequence, valeur, id_type_donnee_mesuree, id_type_calcul, prevu, chemin_fichier_xml, etiquette, enregistre) FROM './mockdata/calcul_enregistre.csv' DELIMITER ',' CSV;
