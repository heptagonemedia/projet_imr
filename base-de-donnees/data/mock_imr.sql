\COPY region (id_region,etiquette) FROM './mockdata/region.csv' DELIMITER ',' CSV;
\COPY bouee (etiquette, longitude_reference, latitude_reference, id_region) FROM './mockdata/bouee.csv' DELIMITER ',' CSV;
\COPY type_donnee (id_type_donnee,etiquette, unite) FROM './mockdata/type_donnee_mesuree.csv' DELIMITER ',' CSV;
...
\COPY type_calcul (id_type_calcul,etiquette) FROM './mockdata/type_calcul.csv' DELIMITER ',' CSV;
